                ...
                <div className="flex-1 relative">
                  ...
                  {captionsEnabled && (
                    <div className="absolute top-2 right-2 z-20">
                      <select value={captionLanguage} onChange={(e) => setCaptionLanguage(e.target.value)} className="bg-gray-900/90 text-white text-xs px-3 py-1.5 rounded-lg border border-green-500/50">
